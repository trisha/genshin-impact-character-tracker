...
sequelize model:create --name stockCharacter --attributes name:string,description:text,rarity:integer,vision:string,hexColor:string,region:string,ascStat:string,headUrl:text,portraitUrl:text,wishUrl:text
